...
function IsoPartnerships() {
  return (
    ...
    <section className="isoPartnerships">
        ...
        <p>If you would like to learn more about our lending procedures at Globex Funding, please don’t hesitate to give us a call. We are happy to provide an honest, straightforward review of our processes and answer any questions you may have.</p>
        <br></br>
