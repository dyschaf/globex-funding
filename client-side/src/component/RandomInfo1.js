    ...
    <>
        <div className="container">
                ...
                <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                    <div className="ym_icon_block">
                        <div className="ym_icon">
                            <img id="completed"src="./img/completed.png" alt=""/>
                        </div>
            ...
            <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div className="ym_icon_block">
                    <div className="ym_icon">
                        <img id="Quick2"src="./img/Quick2.png" alt=""/>
                    </div>
            ...
            <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div className="ym_icon_block">
                    <div className="ym_icon">
                        <img Id="flexable"src="./component/img/flexable.png" alt=""/>
                    </div>
            ...
            <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div className="ym_icon_block">
                    <div className="ym_icon">
                        <img id="money" src="../component/img/money.png" alt=""/>
                    </div>
